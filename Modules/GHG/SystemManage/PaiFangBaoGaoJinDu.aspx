<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaiFangBaoGaoJinDu.aspx.cs" Inherits="Modules_GHG_SystemManage_PaiFangBaoGaoJinDu" %>
...
<body style="height: 59px; width: 611px; margin-left: 100px; margin-top: 43px">
    ...
    <div style="margin-top:30px; height: 23px; width: 532px;">
        ...
        <asp:Label ID="Label3" runat="server" Text="份排放报告,未上传" Font-Size="Larger"></asp:Label>
    ...
    <div style="margin-top:30px">
        ...
        <asp:DropDownList ID="DropDownList1" runat="server" Height="26px" 
            style="margin-left: 27px" Width="148px" Font-Size="Larger">
        </asp:DropDownList>
        ...
        <asp:Label ID="Label8" runat="server" Text="按行业查询：" Font-Size="Larger"></asp:Label>
