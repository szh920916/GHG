<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaiFangYInZi_HuaShiRanLiao.aspx.cs" Inherits="Modules_GHG_DataCollection_TaoCi_PaiFangYInZi_HuaShiRanLiao1" %>
...
<body>
    ...
    <div>
       ...
       <%-- <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GHGSZH %>"
            SelectCommand="SELECT [RanLiaoMingCheng], [DanWeiReZhiHanTanLiang], [TanYangHuaLv],[DiWeiFaReZhi] FROM [View_HuaShiRanLiaoQueShengZhi] WHERE ([QiYeZuZhiJiGouDaiMa] = 888888)">
            <SelectParameters>
                <asp:ControlParameter ControlID="TextBox1" Name="QiYeZuZhiJiGouDaiMa" PropertyName="Text"
                    Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>--%>
    </div>
